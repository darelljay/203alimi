...
const {  signUp, login, sg, clean_Classroom, checkStudentNum } = require('../controllers/controller');
const app = express();
...
router.post('/signUp',async (req,res)=>{
    ...
    await signUp(name,id,password,student_num) === 200 ? res.redirect("http://localhost:3000/html/login.html"):res.render("signup");
